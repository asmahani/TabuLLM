...
We can now cluster the data points using the embedding vectors produced by the LLMs. We will use the \code{SphericalKMeans} class to cluster the data into 10 groups. The following code demonstrates this:
\begin{pyblock}
